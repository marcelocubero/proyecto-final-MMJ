...
renderLeaflet({
  ...
  canton_centro <-
  st_point_on_surface(registros)
  
  
  ebais <- ebais [registros, , op = st_within ]
  ...
  leaflet() %>%
    ...
    addLayersControl(
      ...
      overlayGroups = c("Casos Activos", "Casos Positivos", "Ebais", "Centroides Cantones"),
